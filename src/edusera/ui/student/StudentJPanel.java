 ...
 * @author ingale.r
 */
public class StudentJPanel extends BaseJPanel {

    public StudentJPanel(Business business) {
        super(business);
        initComponents();
        initialSetup();
    }
    ...
    private void initComponents() {
        ...
        lblCourses.setText("Register for Classes >");
        ...
        lblReviewProfessor.setText("Review Professor>");
        ...
        lblViewCertificates.setText("View Certificates>");
        ...
        jLabel2.setFont(new java.awt.Font("STHeiti", 1, 18)); // NOI18N
        ...
        lblNUID.setFont(new java.awt.Font("STHeiti", 1, 18)); // NOI18N
        lblNUID.setText("jLabel4");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblNUID, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lblName, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap(12917, Short.MAX_VALUE))
        );
    ...
    private void initialSetup() {
      ...
      imageResize(lblProfilePic, "./src/edusera/assets/edusera-user-stock-profile-pic.png");
        ...
        // Display greetings d
        lblGreetings.setText("Hello Student!");
        
        lblName.setText(business.getLoggedInUser().getPerson().getName());
        lblNUID.setText(business.getLoggedInUser().getPerson().getNuId());
        lblEmail.setText(business.getLoggedInUser().getPerson().getEmail());
